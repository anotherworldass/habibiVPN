...
/** UI tab ↔ API connect_mode */
export function usageModeFromPref(
  mode: ConnectMode | undefined | null,
): "official" | "third-party" {
  return mode === "subscription_client" ? "third-party" : "official";
}

export function prefFromUsageMode(
  usage: "official" | "third-party",
): ConnectMode {
  return usage === "third-party" ? "subscription_client" : "official_app";
}
