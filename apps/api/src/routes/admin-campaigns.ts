...
import { normalizeCampaignUi } from "../services/growth/types.js";
...
const rewardSchema = z.object({
  kind: z.enum(["vpn_duration", "vpn_traffic"]).optional(),
...
const campaignBody = z.object({
  ...
  type: z.enum(["daily_claim", "lottery"]),
...
const campaignPatch = campaignBody.partial().extend({
  ...
  type: z.enum(["daily_claim", "lottery"]).optional(),
});
