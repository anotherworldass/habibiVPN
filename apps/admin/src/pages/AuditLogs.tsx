...
const ACTION_ENUM: Record<string, { text: string }> = {
  ...
  "settings.support_telegram_forward.clear_bind": { text: "清除客服转发绑定" },
  "settings.support_telegram_forward.test": { text: "测试客服转发 Bot" },
  "settings.support_telegram_forward.upsert": { text: "保存客服转发 Bot" },
